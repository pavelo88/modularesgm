...
export function PublicLayoutClient({
  ...
  // NOTE: Temporarily removed Firebase onSnapshot listener to prevent
  // permission errors from crashing the application. The app will rely on
  // the initial server-provided data until the Firebase connection is fixed.
  //
  // useEffect(() => {
