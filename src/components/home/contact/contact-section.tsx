  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        // MODO CLARO: Cristal Azul suave y transparente. MODO OSCURO: Carbón Sólido.
        "bg-primary/15 backdrop-blur-xl border-primary/20 dark:bg-[#19242D] dark:border-[#B88E44]/40 dark:backdrop-blur-none"
      )}>
