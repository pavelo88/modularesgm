  ...
  return (
    ...
    >
      <div className={cn(
        ...
        "bg-primary/10 backdrop-blur-xl border-white/20 dark:bg-[#19242D] dark:border-[#B88E44]/40 dark:backdrop-blur-none"
      )}>
        <div className="absolute top-[-100px] right-[-100px] w-[300px] h-[300px] bg-primary/40 blur-[150px] opacity-30 pointer-events-none"></div>
        
        {/* Header de la sección integrado en el cristal */}
        <div className="text-center mb-12 relative z-10">
          ...
          <p className={cn(
            ...
            "text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] dark:text-primary dark:drop-shadow-none"
          )}>
