      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6">
          {stats.map((stat) => (
            <Card
              key={stat.id}
              className="p-4 md:p-6 rounded-2xl flex flex-col items-center justify-center text-center hover:-translate-y-2 transition-transform duration-300 group hover:border-primary/50 shadow-lg bg-card/90 dark:bg-card/70 backdrop-blur-sm aspect-square"
            >
